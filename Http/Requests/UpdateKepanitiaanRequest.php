...
class UpdateKepanitiaanRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'struktur_kepanitiaan.*.username.required' => 'Username pada setiap entri wajib diisi.',
            'struktur_kepanitiaan.*.username.string'   => 'Username harus berupa teks.',
            'struktur_kepanitiaan.*.username.exists'   => 'Username yang dimasukkan tidak terdaftar.',
        ];
    }
